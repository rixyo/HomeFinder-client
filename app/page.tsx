...
export default function Home() {
 ...
 <main className='p-2 flex flex-col'>
  ...
  <span className='text-blue-500'> Space</span>
    ...
    { user?.role==="REALTOR" &&
    <h1 className=" text-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-black text-4xl font-bold w-screen p-5">
      List Your Property and Reach Potential Buyers with <span className='underline text-sky-500'> Ease</span> 
  <span className="block text-lg text-blue-500  mt-5 font-bold">Unlock the Power of Our Platform to Sell Your Property Quickly and Efficiently</span>
    </h1>
    } 
